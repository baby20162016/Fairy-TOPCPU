...
##点积计算
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @s pn_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h *= @e[tag=pn_p1] pn_gra_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h = @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h *= @e[tag=pn_p1] pn_gra_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h += @s pn_h
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @s pn_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players remove @s pn_h 160
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h *= @e[tag=pn_p2] pn_gra_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p2] pn_h = @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p2] pn_h *= @e[tag=pn_p2] pn_gra_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p2] pn_h += @s pn_h
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @s pn_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players remove @s pn_h 160
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h *= @e[tag=pn_p3] pn_gra_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p3] pn_h = @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players remove @e[tag=pn_p3] pn_h 160
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p3] pn_h *= @e[tag=pn_p3] pn_gra_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p3] pn_h += @s pn_h
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @s pn_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h *= @e[tag=pn_p4] pn_gra_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p4] pn_h = @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players remove @e[tag=pn_p4] pn_h 160
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p4] pn_h *= @e[tag=pn_p4] pn_gra_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p4] pn_h += @s pn_h

##加权
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @s pn_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run function random_terrain/fade
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p2] pn_h *= @s pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p3] pn_h *= @s pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players set @s pn_h 160
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h -= @s pn_x
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run function random_terrain/fade
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h *= @s pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p4] pn_h *= @s pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h += @e[tag=pn_p2] pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p4] pn_h += @e[tag=pn_p3] pn_h
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run function random_terrain/fade
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p4] pn_h *= @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players set @s pn_h 160
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h -= @s pn_z
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run function random_terrain/fade
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h *= @s pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @e[tag=pn_p1] pn_h += @e[tag=pn_p4] pn_h
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h = @e[tag=pn_p1] pn_h
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h /= "a1" pn_a
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h /= "a7" pn_a
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_set = "mode" pn_set 
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players add @s pn_h 20
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run scoreboard players operation @s pn_h /= "a2" pn_a
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s run tag @e[name=pn_set] add pn_set2
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s run tag @e[name=pn_set] add pn_set3
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s run tag @e[tag=pn_p1] remove pn_p1
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s run tag @e[tag=pn_p2] remove pn_p2
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s run tag @e[tag=pn_p3] remove pn_p3
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s run tag @e[tag=pn_p4] remove pn_p4
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s as @e[name=pn_set,scores={pn_gra_x=0,pn_z=0}] at @s run kill @e[name=pn_p]
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=150,pn_z=150}] at @s as @e[name=pn_set,scores={pn_gra_x=0,pn_z=0}] at @s run kill @s
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s as @s[scores={pn_x=80,pn_z=80}] at @s run tag @r[type=minecraft:armor_stand,name=pn_pm] add pn_tree
#
execute as @e[c=1,name=pn_pm,tag=!pn_h] at @s run tag @s add pn_h
...
execute as @e[name=pn_pm,tag=pn_h,scores={pn_h=1},tag=tree] at @s run scoreboard players random @s pn_random 1 2
execute as @e[name=pn_pm,tag=pn_h,scores={pn_h=1,pn_random=1}] at @s if block ~ ~ ~ minecraft:air[] run setblock ~ ~ ~ minecraft:tallgrass
execute as @e[name=pn_pm,tag=pn_h,scores={pn_h=1,pn_random=1},tag=pn_tree] at @s run function random_terrain/tree
